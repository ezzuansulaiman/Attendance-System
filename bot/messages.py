...
def build_bot_guide_text() -> str:
    return (
        ...
        "• Tekan <b>Mohon Cuti</b> dalam menu dan ikuti langkah-langkah:\n"
        "   ① Pilih jenis cuti (Tahunan / Sakit / Kecemasan)\n"
        "   ② Pilih tarikh mula menggunakan butang\n"
        "      (Cuti Tahunan: taip tarikh dalam format YYYY-MM-DD atau DD/MM/YYYY)\n"
        "   ③ Pilih tarikh akhir menggunakan butang\n"
        "   ④ Pilih bahagian hari jika cuti sehari sahaja\n"
        "   ⑤ Pilih atau taip sebab cuti\n"
        "   ⑥ Muat naik gambar sokongan (untuk Cuti Sakit &amp; Kecemasan)\n"
        "      — <b>Balas</b> mesej bot dengan foto MC / surat doktor\n"
